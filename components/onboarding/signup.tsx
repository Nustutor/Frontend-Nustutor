...
const Signup = () => {
  return (
    <div className="w-[1440px] h-[1041px] relative overflow-hidden bg-[#fffefc]">
  <div className="w-[737px] h-[963px]">
    <div className="w-[737px] h-[963px] absolute left-[40.5px] top-[37.5px] rounded-[29px] bg-gradient-to-b from-[#977644]/[0.35] to-black/[0.35]" />
  ...
  <div className="w-[454px] h-[573px]">
    ...
    <div className="flex flex-col justify-start items-center absolute left-[889px] top-[304px] gap-16">
      <div className="flex-grow-0 flex-shrink-0 w-[454px] h-[523px]">
        <div className="flex flex-col justify-start items-start absolute left-0 top-[91px] gap-6">
          <div className="flex-grow-0 flex-shrink-0 w-[435px] h-[90px]">
            <div className="w-[435px] h-[54px] absolute left-[-0.5px] top-[35.5px] rounded-[40px] bg-white border border-[#9e896a]" />
            <p className="absolute left-0 top-0 text-base text-left text-black">Email</p>
            <p className="absolute left-[31px] top-[54px] text-[15px] font-light text-left text-[#acacac]">
              Enter your Email
            </p>
          </div>
          <div className="flex-grow-0 flex-shrink-0 w-[435px] h-[90px]">
            <div className="w-[435px] h-[54px] absolute left-[-0.5px] top-[149.5px] rounded-[40px] bg-white border border-[#9e896a]" />
            <p className="absolute left-0 top-[114px] text-base text-left text-black">User name</p>
            <p className="absolute left-[31px] top-[168px] text-[15px] font-light text-left text-[#acacac]">
              Set your Username
            </p>
          </div>
          <div className="flex-grow-0 flex-shrink-0 w-[435px] h-[90px]">
            <div className="w-[435px] h-[90px]">
              <div className="w-[435px] h-[54px] absolute left-[-0.5px] top-[263.5px] rounded-[40px] bg-white border border-[#9e896a]" />
              <p className="absolute left-0 top-[228px] text-base text-left text-black">Password</p>
              <p className="absolute left-[31px] top-[282px] text-[15px] font-light text-left text-[#acacac]">
                Enter your Password
              </p>
            </div>
            <svg
              ...
              className="w-[18px] h-[18px] absolute left-[389px] top-[282px]"
          ...
          <div className="flex-grow-0 flex-shrink-0 w-[435px] h-[90px]">
            <div className="w-[435px] h-[54px] absolute left-[-0.5px] top-[377.5px] rounded-[40px] bg-white border border-[#9e896a]" />
            <svg
              width={18}
              height={18}
              viewBox="0 0 18 18"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="w-[18px] h-[18px] absolute left-[389px] top-[396px]"
              preserveAspectRatio="none"
            >
              <g clip-path="url(#clip0_162_808)">
                <path
                  d="M8.86304 6.14936L11.4397 8.72604L11.452 8.59107C11.452 7.23728 10.3518 6.13708 8.99801 6.13708L8.86304 6.14936Z"
                  fill="black"
                />
              ...
              <defs>
                <clippath id="clip0_162_808">
                  <rect width={18} height={18} fill="white" />
                </clippath>
              </defs>
            </svg>
            <p className="absolute left-0 top-[342px] text-base text-left text-black">
              Confirm Password
            </p>
            <p className="absolute left-[31px] top-[396px] text-[15px] font-light text-left text-[#acacac]">
      ...
      <div className="flex-grow-0 flex-shrink-0 w-[232px] h-[49px]">
        <div className="w-[232px] h-[49px] absolute left-[110.5px] top-[586.5px] rounded-[36px] bg-[#9e896a]" />
        <p className="absolute left-[205px] top-[600px] text-base text-left text-white">Signup</p>
      </div>
    </div>
  </div>
  <img
