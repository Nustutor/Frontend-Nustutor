...
const IdDropdown = ({ title, options, onSelect, selectedOption, suids }) => {
    ...
    const handleOptionSelect = (option) => {
      ...
      onSelect(option, suids[selectedIndex]); // Pass the corresponding suid
      setIsOpen(false);
    };
    ...
    return (
      <div className="max-h-screen flex items-center justify-center p-2">
        <div className="relative group">
          ...
          >
            <span className="mr-2">{selectedOption || title}</span>
