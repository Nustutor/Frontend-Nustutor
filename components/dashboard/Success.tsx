...
const Success = ({SuccessText}) => {
  ...
  <div className="flex flex-col justify-center items-center gap-8 pb-8 px-4">
    <div className="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-2.5 w-full max-w-screen-md py-8 bg-white">
      <div className="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 relative gap-4">
        <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 w-full relative overflow-hidden">
        <svg
                width={94}
                height={104}
                viewBox="0 0 94 104"
        ...
        <p className="text-4xl font-black text-center text-[#111928]">
          {SuccessText}
        </p>
    ...
    <div className="flex justify-center items-center flex-grow-0 flex-shrink-0 relative px-4 py-3 rounded-lg bg-[#17c817] cursor-pointer" onClick={handleClick}>
