...
const Interface = () => {
  ...
  <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-2 mt-4">
    ...
    <div className="flex flex-col justify-start items-start flex-grow relative gap-1.5">
      <p className="text-base font-medium text-left text-[#111928]">
        Schedule personalized sessions
      </p>
    </div>
  </div>
  <div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-2 mt-2">
    <svg
      width={20}
      height={21}
      viewBox="0 0 20 21"
  ...
  <div className="hidden md:flex justify-start items-center flex-grow-0 flex-shrink-0 w-[1280px] gap-16">
    <div className="flex flex-col justify-start items-start flex-grow gap-8">
      <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-4">
        <p className="self-stretch flex-grow-0 flex-shrink-0 w-[608px] text-4xl font-bold text-left text-[#111928]">
          Tutee Mode
        </p>
...
<br/><br/>
      ...
      <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative">
        <div className="self-stretch flex-grow-0 flex-shrink-0 h-px bg-gray-200" />
        <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-6">
          <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 gap-4 pt-8">
...
Receive instant support<br/>
    ...
    <div className="flex flex-col justify-start items-start flex-grow relative gap-2.5 p-2.5">
      <img
        src="/interface1.png"
        className="self-stretch flex-grow-0 flex-shrink-0 h-[511px] object-contain"
      />
    </div>
  </div>
...
<div className="flex justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-2 mt-2">
  ...
  <div className="flex flex-col justify-start items-start flex-grow relative gap-1.5">
    <p className="text-base font-medium text-left text-[#111928]">
      Teach others and grow yourself<br/>
    </p>
  </div>
</div>
...
<div className="hidden md:flex justify-start items-center flex-grow-0 flex-shrink-0 w-[1280px] gap-16">
    <div className="flex flex-col justify-start items-start flex-grow relative gap-2.5 pr-2.5 py-2.5">
      <img
        src="/interface2.png"
        className="flex-grow-0 flex-shrink-0 w-[608px] h-[456px] object-contain"
      />
    </div>
    <div className="hidden md:flex flex-col justify-start items-start flex-grow gap-8">
      <div className="flex flex-col justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-4">
        <p className="self-stretch flex-grow-0 flex-shrink-0 w-[608px] text-4xl font-bold text-left text-[#111928]">
          Tutor Mode
        </p>
