...
<div className="hidden md:flex justify-between items-center flex-grow-0 flex-shrink-0 relative gap-4 cursor-pointer">
  <div> {loading && <Loader LoaderText={'Loading'} />}
  <div onClick={handleLClick} >
  <p className="flex-grow-0 flex-shrink-0 text-base font-medium text-center text-[#111928]" style={{paddingLeft: "37em"}}>
    Log In
    </p>
    </div>
    </div>
