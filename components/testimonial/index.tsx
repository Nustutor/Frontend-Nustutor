...
const Testimonial = () => {
  return (
    <div>
    <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-2.5 py-8 md:py-24 bg-gray-50 md:hidden">
    <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-full md:w-[1280px] gap-8 md:gap-16">
      <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-full md:w-[1216px] gap-4 md:gap-6">
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative pt-[9px]">
        ...
        <div className="flex flex-col justify-start items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-2">
          <p className="flex-grow-0 flex-shrink-0 w-full md:w-[768px] text-base md:text-lg font-semibold text-center text-[#111928]">
        ...
        <div className="flex justify-center items-center self-stretch flex-grow-0 flex-shrink-0 relative gap-2">
          <div className="flex-grow-0 flex-shrink-0 w-4 h-4 md:w-6 md:h-6 relative rounded-full bg-cover bg-no-repeat bg-center" />
          <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-2">
            <p className="flex-grow-0 flex-shrink-0 text-sm md:text-base font-semibold text-left text-[#111928]">
              Momin Ahmed
            </p>
            <p className="flex-grow-0 flex-shrink-0 text-sm md:text-base font-semibold text-left text-[#111928]">
              /
            </p>
            <p className="flex-grow-0 flex-shrink-0 text-xs md:text-sm text-left text-gray-500">
              HKUST, Hong Kong
            </p>
          </div>
        </div>
