...
const Hero = ({Username}: {Username: any}) => {
  ...
  return (
    <div>
      <div className="flex flex-col justify-start items-center relative gap-8 pb-16 md:hidden">
      <div className="flex flex-col justify-center items-center flex-grow-0 flex-shrink-0 overflow-hidden gap-4 px-6 py-10 bg-white">
    <svg
      width={80}
      height={88}
      viewBox="0 0 80 88"
    ...
    <p className="text-3xl font-black text-center text-[#111928]">
      <span className="text-3xl font-black text-center text-[#111928]">
        Welcome to Nustutor,
      </span>
      <br />
      <span className="text-3xl font-black text-center text-[#111928]">
    ...
    <p className="text-base text-center text-gray-500">
      Explore our offerings suited to your degree program &amp; start learning today!{" "}
    </p>
  </div>
  <Searchbar />
</div>

    <div className="hidden md:flex flex-col justify-start items-center relative gap-16 pb-16">
